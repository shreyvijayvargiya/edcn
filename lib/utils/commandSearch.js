...
const LEFT_TABS = [
	...
	{ id: "ai", label: "AI agent", keywords: "openai generate assistant" },
	{ id: "ui", label: "UI components", keywords: "buttons inputs mock saas demo" },
	{ id: "text", label: "Text", keywords: "typography fonts titles" },
	{ id: "captions", label: "Captions", keywords: "subtitles srt vtt karaoke tiktok reels shorts" },
	{ id: "image", label: "Images", keywords: "photos pictures stock upload" },
	{ id: "video", label: "Video", keywords: "clips footage upload sample screen record" },
	{ id: "audio", label: "Audio", keywords: "sound music sfx upload mic record" },
...
const PROPERTY_SECTIONS = [
	...
	{ id: "timing", label: "Timing", description: "Clip start, duration, enter/exit/loop", keywords: "duration animation delay exit loop" },
	{ id: "advanced-motion", label: "Advanced motion", description: "Keyframes, path, anchor, easing", keywords: "motion keyframe path spring easing" },
...
const ACTION_ITEMS = [
	...
	{ id: "action-record-screen", label: "Record screen", keywords: "capture window tab webcam pip demo" },
	{ id: "action-record-audio", label: "Record audio", keywords: "mic voiceover narration" },
	{ id: "action-add-captions", label: "Add captions", keywords: "subtitles karaoke srt vtt" },
];
	...
	switch (action.type) {
		...
		case "editor-action":
			switch (action.name) {
				...
				case "record-screen":
					openLeftPanel?.();
					dispatch({ type: "videoEditor/openRecordScreenModal", payload: { insertAt: "end" } });
					break;
				case "record-audio":
					openLeftPanel?.();
					dispatch({ type: "videoEditor/openRecordAudioModal", payload: { insertAt: "end" } });
					break;
				case "add-captions":
					openLeftPanel?.();
					dispatch({
						type: "videoEditor/runCommandNavigation",
						payload: { leftTab: "captions" },
					});
					break;
				default:
					break;
