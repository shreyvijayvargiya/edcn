...
export const LAYER_EXIT_PRESETS = [
	{ id: "none", label: "None", description: "No exit animation" },
	{ id: "fade_out", label: "Fade out", description: "Opacity → 0" },
	{ id: "slide_up", label: "Slide up", description: "Exit upward" },
	{ id: "slide_down", label: "Slide down", description: "Exit downward" },
	{ id: "slide_left", label: "Slide left", description: "Exit to the left" },
	{ id: "slide_right", label: "Slide right", description: "Exit to the right" },
	{ id: "zoom_out", label: "Zoom out", description: "Scale down & fade" },
	{ id: "pop_out", label: "Pop out", description: "Scale bounce out" },
	{ id: "spin_out", label: "Spin out", description: "Rotate while fading" },
];

export const LAYER_EXIT_GROUPS = [
	{ label: "Exit", options: LAYER_EXIT_PRESETS },
];

export const LAYER_LOOP_MODES = [
	{ id: "none", label: "None" },
	{ id: "loop", label: "Loop" },
